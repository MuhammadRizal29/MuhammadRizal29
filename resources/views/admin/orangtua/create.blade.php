...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <h2 class="text-2xl font-semibold leading-tight">Tambah Data Orang Tua Baru</h2>
        ...
        <form action="{{ route('admin.orangtua.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf

            <div class="mb-4">
                <label for="c_orangtua" class="block text-gray-700 text-sm font-bold mb-2">Kode Orang Tua:</label>
                <input type="text" name="c_orangtua" id="c_orangtua" value="{{ $c_orangtua }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" readonly>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="pekerjaan" id="pekerjaan" value="{{ old('pekerjaan') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('pekerjaan') border-red-500 @enderror" required>
                @error('pekerjaan')
                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="hubungan_dengan_santri" id="hubungan_dengan_santri" value="{{ old('hubungan_dengan_santri') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('hubungan_dengan_santri') border-red-500 @enderror" required>
