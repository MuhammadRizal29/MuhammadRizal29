...
<head>
    ...
    <title>@yield('title', 'Dashboard Guru') - Sistem Informasi Pesantren</title>
...
<body class="bg-gray-100 flex h-screen overflow-hidden">
    ...
    <aside class="sidebar text-white h-full flex flex-col items-center space-y-6 py-7 absolute inset-y-0 left-0 transform transition duration-300 ease-in-out md:relative md:translate-x-0">
        ...
        <!-- Navigation -->
        <nav class="w-full">
            <a href="{{ route('guru.dashboard') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-tachometer-alt mr-3"></i>
                <span>Dashboard</span>
            </a>
            <a href="{{ route('guru.prestasi.index') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-trophy mr-3"></i>
                <span>Prestasi</span>
            </a>
            <a href="{{ route('guru.kegiatan.index') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-calendar-alt mr-3"></i>
                <span>Kegiatan</span>
            </a>
            <a href="{{ route('guru.pelanggaran.index') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-exclamation-triangle mr-3"></i>
                <span>Pelanggaran</span>
            </a>
            <a href="{{ route('guru.hafalan.index') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-book mr-3"></i>
                <span>Hafalan</span>
            </a>
            <a href="{{ route('guru.kelas.index') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-chalkboard mr-3"></i>
                <span>Kelas</span>
            </a>
            <a href="{{ route('guru.pengaturan') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800 w-full">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <h1 class="text-2xl font-semibold text-gray-900">@yield('header', 'Dashboard Guru')</h1>
