...
<head>
    ...
    <title>@yield('title', 'Dashboard Orang Tua') - Sistem Monitoring Santri</title>
...
<body class="bg-gray-100 flex h-screen overflow-hidden">
    ...
    <aside class="sidebar text-white h-full flex flex-col items-center space-y-6 py-7 absolute inset-y-0 left-0 transform transition duration-300 ease-in-out md:relative md:translate-x-0">
        ...
        <!-- Navigation -->
        <nav class="w-full">
            <a href="{{ route('orangtua.dashboard') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-tachometer-alt mr-3"></i>
                <span>Dashboard</span>
            </a>
            <a href="{{ route('orangtua.biodata') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-user-graduate mr-3"></i>
                <span>Biodata Santri</span>
            </a>
            <a href="{{ route('orangtua.prestasi') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-trophy mr-3"></i>
                <span>Prestasi</span>
            </a>
            <a href="{{ route('orangtua.hafalan', ['nis' => $santri->nis]) }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
                <i class="fas fa-book-reader mr-3"></i>
                <span>Hafalan</span>
            </a>
            <a href="{{ route('orangtua.pelanggaran') }}" class="flex items-center py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                <h1 class="text-2xl font-semibold text-gray-900">@yield('header', 'Dashboard Orang Tua')</h1>
